...
public class DBManagerException extends Exception {
	...
	/*
	 * Error 1: conectar a la DB Error 2: mostrar alumnos Error 3: obtener alumnos Error 4:
	 * obtener alumno Error 5: insertar Error 6: modificar Error 7: eliminar alumno
	 * Error 8: cerrar coconexiónnexion a la db
	 */
	 ...
	 * Error 8: cerrar conexión a la db
	 */
	...
	public String getMessage() {
		...
		case ERROR_3:
			return "Se produjo un error obteniendo alumnos. Error: " + super.getMessage();
		case ERROR_4:
		...
		case ERROR_8:
			return "Se produjo un error cerrando la conexión con la DB. Error: " + super.getMessage();
		default:
